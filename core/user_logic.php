                ...
                <table cellpadding="0" cellspacing="0" class="force-full-width">
                                ...
                                <td style="width:200px;background:#008000;">
                                  <div><!--[if mso]>
                                    <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:40px;v-text-anchor:middle;width:200px;" stroke="f" fillcolor="#008000">
                                      ...
                                      <center>
                                    <![endif]-->
                                        <a href="https://prifa.com.ng/property.php?pro='.$property_no.'"
                  ...
                  <tr>
                    <td valign="top" class="footer-cell">
                     Prifa<br>
                      an <a href="https://prifa.com.ng"  target="_blank" > Prifa</a>, INC company
                    </td>
                  </tr>
                </table>
              </td>
        ...
        $sql="SELECT * FROM users WHERE email='$user_check' AND  password='$password'";
            ...
            if($row['password']!=$password){
               ...
               $alert='<div class="notification error closeable">
                    <p><span>Password not correct</span> </p>
                ...
                $sms_code = $row2['sms_code'];
                 ...
                 if($row2['type']=='Agent'){
                  ...
                  $postdata = http_build_query(
                       array(
                    'username' => 'e3techngltd@gmail.com',
                    'password' => 'admin@e3',
          ...
          if (isset($_POST['comfirm-agent'])) {
              ...
              $row=mysqli_fetch_array($result); 
                  ...
                  if($row['sms_code']!==$sms_code){
                   ...
                   $alert = '<div class="notification error closeable">
                              <p><span>Invalid Verification Code</span> </p>
                              <a class="close" href="#"></a>
                            </div>';
