...
$sql_sear_pro = "SELECT * FROM property WHERE  (`address` LIKE '%".$p_location."%' OR `state` LIKE '%".$p_location."%' OR `lga` LIKE '%".$p_location."%') OR (`type` LIKE '%".$p_type."%') AND status=1 ";
    ...
    if ($num_rows=="") {
      $error ='<div class="notification warning closeable">
                <p><span>We are sorry, your search did not match</span> </p>
