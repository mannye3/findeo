		...
		<div class="col-md-4">
			...
			<div class="sidebar-textbox">
				...
				<ul class="contact-details">
					...
					<li><i class="im im-icon-Envelope"></i> <strong>E-Mail:</strong> <span><a href="#"><span class="__cf_email__" data-cfemail="9cf3fafaf5fff9dcf9e4fdf1ecf0f9b2fff3f1">info@prifa.com.ng</span></a></span></li>
				</ul>
			</div>
			...
			<section id="contact">
				...
				<div id="contact-message"></div> 
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div>
								<input name="email" type="email" placeholder="Email Address" pattern="^[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})$" required="required" />
							</div>
						</div>
					</div>
