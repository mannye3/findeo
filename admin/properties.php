                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript: void(0);">
                                                    <img src="../uploads/<?php echo $rw5["pic"]; ?>"  />
                                            ...
                                            <td>
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="core/delete.php?pro=<?php echo $rw5["property_no"];?> " onclick="return confirm('Are you sure you want to DELETE PROPERTY ?')"><i class="mdi mdi-delete mr-2 text-muted font-18 vertical-middle"></i>Remove</a>
